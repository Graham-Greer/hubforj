...
export function normalizeEventRecord(event) {
  ...
  return {
    ...
    attendancePresentCount: normalizeEventInteger(event.attendancePresentCount, 0),
    attendanceAbsentCount: normalizeEventInteger(event.attendanceAbsentCount, 0),
    attendancePendingCount: normalizeEventInteger(event.attendancePendingCount, 0),
    attendanceMarkedCount: normalizeEventInteger(event.attendanceMarkedCount, 0),
    attendanceSummarySchemaVersion: normalizeEventInteger(event.attendanceSummarySchemaVersion, 0),
    attendanceSummaryUpdatedAt: normalizeString(event.attendanceSummaryUpdatedAt),
    attendanceSummaryUpdatedBy: normalizeString(event.attendanceSummaryUpdatedBy),
